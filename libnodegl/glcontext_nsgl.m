...
static int glcontext_nsgl_create(struct glcontext *glcontext, void *other)
{
    ...
    if (glcontext->offscreen) {
        ...
        glRenderbufferStorage(GL_RENDERBUFFER, GL_RGBA8, glcontext->offscreen_width, glcontext->offscreen_height);
        ...
        glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, glcontext->offscreen_width, glcontext->offscreen_height);
...
static void *glcontext_nsgl_get_display(struct glcontext *glcontext)
{
    return NULL;
}

static void *glcontext_nsgl_get_window(struct glcontext *glcontext)
{
    return NULL;
}
...
const struct glcontext_class ngli_glcontext_nsgl_class = {
    ...
    .get_display = glcontext_nsgl_get_display,
    .get_window = glcontext_nsgl_get_window,
