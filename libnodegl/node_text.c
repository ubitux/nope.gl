...
static int bg_prepare(struct ngl_node *node, struct pipeline_subdesc *desc)
{
    ...
    state.stencil_func       = NGLI_COMPARE_OP_ALWAYS;
    state.stencil_ref        = 1;
    state.stencil_read_mask  = 0xFF;
    state.stencil_fail       = NGLI_STENCIL_OP_REPLACE;
    state.stencil_depth_fail = NGLI_STENCIL_OP_REPLACE;
    state.stencil_depth_pass = NGLI_STENCIL_OP_REPLACE;
...
static int fg_prepare(struct ngl_node *node, struct pipeline_subdesc *desc)
{
    ...
    state.stencil_func       = NGLI_COMPARE_OP_EQUAL;
    state.stencil_ref        = 1;
    state.stencil_read_mask  = 0xFF;
    state.stencil_fail       = NGLI_STENCIL_OP_KEEP;
    state.stencil_depth_fail = NGLI_STENCIL_OP_KEEP;
    state.stencil_depth_pass = NGLI_STENCIL_OP_KEEP;
