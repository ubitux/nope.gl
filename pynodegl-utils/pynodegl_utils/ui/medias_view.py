...
def medias_view():
    add_button('+##medias add')
    add_same_line()
    add_button('-##medias rm')
    add_same_line()
    add_button('##medias moveup', arrow=True, direction=2)
    add_same_line()
    add_button('##medias movedown', arrow=True, direction=3)
    add_listbox('##medias list', items=['hello', 'world'])
