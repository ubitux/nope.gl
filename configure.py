...
_EXTERNAL_DEPS = dict(
    ...
    nopemd=dict(
        ...
        sha256="1a6b78395f6be6c093340fe09eb375b9039992206a627dd224815de9ca17e6b7",
    ),
    egl_registry=dict(
        version="9ab6036",
    ...
    renderdoc_Windows=dict(
        ...
        sha256="443e1f53dc3a872e84b31912e150b2648756476a05d9ff9e13839f7db01b6074",
    ),
...
def _htmldoc(cfg):
    version = "v" + open("VERSION").read().rstrip()
    return [_cmd_join("sphinx-build", "-W", "-D", f"version={version}", "doc", op.join("builddir", "doc"))]
